...
def main():
    ...
    evidence = Path(tempfile.mkdtemp(prefix="dc_feature_gate_", dir=ROOT/"tmp"))
    ...
    record = dict(schema_version=1, passed=True, evidence_directory=str(evidence),
        ...
        stages=stages, dc_pipeline=audit, runtime=runtime_identity(), source_sha256=tested_sources)
